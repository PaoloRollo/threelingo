...
export const availableCourses: Course[] = [
  {
    ...
    sections: [
      {
        ...
        units: [
          ...
          /**
           * - Unit 3: Transactions, P2P, and Smart Contract Interactions
    - **Step 1: Blockchain Transactions**
        - Multiple Choice Question:
            - What is a blockchain transaction primarily used for?
                - A) Creating new cryptocurrencies
                - B) Updating blockchain software
                - **C) Recording and verifying data or value transfers** ✅
                - D) Securing wallet access
        ...
        - Multiple Choice Question:
            - What does the term 'gas' refer to in the context of blockchain transactions?
                - A) The physical energy required to maintain the network
                - **B) The fee required to conduct a transaction on a blockchain network** ✅
                - C) A type of cryptocurrency
                - D) The storage space a transaction occupies on the blockchain
        - True or False Question:
        ...
        - Multiple Choice Question:
            - Which of the following best describes a 'smart contract'?
                - A) A legal agreement between two parties in digital form
                - **B) A computer protocol intended to digitally facilitate, verify, or enforce the negotiation or performance of a contract** ✅
                - C) A contract that is signed using a smart pen
                - D) An AI-generated contract that does not require human input
        - True or False Question:
        ...
        - Multiple Choice Question:
            - What is required to execute a function on a smart contract in a blockchain?
                - A) A verbal agreement between the parties involved
                - B) A certain amount of cryptocurrency must be mined
                - **C) A transaction that calls the contract's function** ✅
                - D) Approval from a majority of network nodes
    - **Step 2: Peer-to-Peer (P2P) Transactions**
        - Interactive Task:
            - Make a transfer of 1 USDC. Send it back to our wallet
    - **Step 3: Smart Contracts Overview**
        - Fill in the Gap:
        ...
        - Multiple Choice Question:
            - What enables smart contracts to execute transactions without human intervention?
                - A) Manual approval by blockchain developers
                - **B) Predefined conditions coded within the contract** ✅
                - C) A consensus vote by all network participants
                - D) Periodic maintenance checks by network administrators
        - True or False Question:
        ...
        - Multiple Choice Question:
            - What is a potential benefit of using smart contracts over traditional contracts?
                ...
                - B) They are slower to execute
                - **C) They reduce the likelihood of fraud and errors** ✅
    ...
    - **Step 6: Transaction Exploration**
        - Interactive Task:
    ...
    - **Step 7: Gas Fees**
        - Multiple Choice Question:
            - What are gas fees in blockchain transactions?
                - A) Fees paid for generating new coins
                - **B) Fees for executing smart contracts** ✅
                - C) Fees charged by wallet providers
                - D) Fees to access blockchain data
        - Fill in the Gap:
        ...
        - Multiple Choice Question:
            - What can users do to potentially reduce their gas fees when sending transactions?
                - A) Wait for times when network congestion is high
                - B) Use a different blockchain with lower fees
                - C) Increase the gas limit for their transactions
                - **D) Lower the gas price or choose off-peak times** ✅
